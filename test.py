...
def test(img_en_path, imp_de_path, fin_de_path, args):
    ...
    # Models
    image_encoder = ImageEncoder().eval().to(device)
...
if __name__ == '__main__':
    ...
    # paths
    parser.add_argument('--model_path', type=str, default='model_weight', help='path for weights')
    parser.add_argument('--vocab_path', type=str, default='Data/IUdata_vocab_0threshold.pkl', help='path for vocabulary wrapper')
    parser.add_argument('--image_dir', type=str, default='Data/NLMCXR_Frontal', help='directory for X-ray images')
    parser.add_argument('--eval_json_dir', type=str, default='Data/IUdata_test.json', help='the path for json file')
    # model parameters
